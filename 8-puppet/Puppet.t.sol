...
contract PuppetChallenge is Test {
    ...
    /*
    Lỗ hổng:
    Pool dùng giá on-chain từ Uniswap v1 reserves để tính collateral; 
    Uniswap v1 có thanh khoản nhỏ nên giá dễ bị thao túng bằng 1 trade lớn; 
    attacker có thể hạ giá DVT so với ETH, làm giảm mạnh khoản ETH cần đặt cọc.
    Crack:
    Dump DVT lên Uniswap V1 (swap DVT → ETH) để làm sập giá DVT.
    Dùng ETH ít ỏi còn lại làm collateral rẻ để vay toàn bộ 100k DVT từ lending pool.
    Chuyển DVT thu được về recovery.
    */
